...
namespace OSFMServerBanlogBot
{
    ...
    public class CommandModule : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task Update()
        {
            ...
            using (Context.Channel.EnterTypingState())
            {
                GitHubClient client = new GitHubClient(new ProductHeaderValue("***REMOVED***gamedev-the-baa"));
                Release latestRelease = client.Repository.Release.GetAll("***REMOVED***gamedev", "the-baa").Result[0];
